...
export default function VideoInterview() {
  ...
  return <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
    ...
    {!joined ? <div className="card" style={{ margin: 16, maxWidth: 560 }}>
      <p>Hello {d.candidate}. This is a recorded video interview of about 15 minutes. You will be asked {d.questions.length} questions; the text of each appears on screen so you can take a moment before answering. Please complete it alone in a quiet place. The recording is encrypted, seen only by the school's recruiting team, and deleted after 90 days. Write to hr@healthyplanetschool.com to have it deleted sooner.</p>
