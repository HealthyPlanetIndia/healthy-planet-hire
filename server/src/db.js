...
export const DEFAULT_SCENARIOS = [
  ...
  { id: "s4", type: "situation", title: "Disengaged group while others participate", assesses: "Classroom management", setup: "In a Grade 4 EVS discussion, six children are fully engaged and answering, while a group of five at the back have quietly stopped participating and are drawing in their notebooks.", twist: "One of the five says, when you approach, 'the same people always get to answer anyway'.", observe: "Do they notice this as a participation-structure problem rather than a discipline problem? Do they change how they call on children (think-pair-share, cold call with warning, roles)? Do they respond to the child's comment with curiosity rather than correction?" },
  { id: "s5", type: "situation", title: "Checking whether the class has understood", assesses: "Subject knowledge", setup: "You have just taught fractions as parts of a whole to Grade 4. Everyone nodded. You have eight minutes left in the period.", twist: "A quick check shows half the class thinks one quarter is bigger than one third because four is bigger than three.", observe: "Do they use a real check (mini whiteboards, hinge question, exit ticket) rather than 'any doubts?'. Do they know this specific misconception and have a concrete way to address it (fraction strips, sharing a chapati)? Do they plan for the next lesson rather than only the next eight minutes?" },
  { id: "s6", type: "situation", title: "Responding to an incorrect answer", assesses: "Child-centred practice", setup: "You ask the class what the water cycle's first step is and Meera, a quiet child, confidently says 'rain' in front of everyone. Two children giggle.", twist: "Meera's face falls and she says 'sorry, I'm wrong'.", observe: "Do they protect Meera's dignity while still correcting the idea? Do they treat the answer as useful ('rain is part of it, where does the rain come from?')? Do they address the giggling? Would Meera answer again next time?" },
  { id: "s7", type: "situation", title: "A child who repeatedly disturbs the class", assesses: "Classroom management", setup: "Dev (Grade 5) calls out, taps his pen loudly and makes classmates laugh several times every lesson. Warnings work for five minutes.", twist: "His previous class teacher tells you he was 'a nightmare all year' and the parents 'don't care'.", observe: "Do they look for what Dev gets from the behaviour and what happens before it? Do they have a plan beyond warnings (a role, movement, a private conversation, a signal)? Do they resist the previous teacher's framing and keep the relationship with the parents open?" },
];
