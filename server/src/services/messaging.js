...
export const DEFAULT_TEMPLATES = {
  Applied: "Hello {name}, thank you for applying for the {role} position at Healthy Planet School, {campus} campus. We have received your application and will review it against the role's requirements. You will hear from us within five working days about the next step. If you did not intend to apply for this role, please reply here.",
  "General application": "Hello {name}, thank you for sending your resume to Healthy Planet School. There is no opening that matches right now, so we have kept your profile in our talent pool and will reach out when a suitable role comes up at either campus. If you did not intend to send this, please reply here.",
  ...
  "AI interview": "Hello {name}, thank you for applying for {role} at Healthy Planet School. The first round is a recorded video interview with Maya, our AI interviewer: 4 short questions and one classroom scenario, about 12 to 15 minutes. Please complete it before {deadline}.\n\nTo do it justice:\n1. Use a laptop or desktop if you can (a phone works if placed on a stable surface at eye level).\n2. A quiet, private, well-lit room, with the light in front of you.\n3. 15 uninterrupted minutes; no notes, no help. Each answer has up to 90 seconds.\n4. You get 3 seconds before recording starts on each answer, you can ask Maya to repeat a question, and you may re-record one answer.\n\nYour link: {link}\n\nAll the best. Reply here if you have any difficulty.",
  ...
  "Leadership interview": "Hello {name}, we would like to invite you to meet our Principal for the {role} position at Healthy Planet School. {slots}. Please bring your original certificates and a photo ID. Reply here if anything changes.",
  "Subject assessment": "Hello {name}, the next step for {role} at Healthy Planet School is a subject discussion with our Department Coordinator. {slots}. It lasts about 30 minutes and focuses on how you teach your subject to this age group.",
  "Demo lesson": "Hello {name}, we would like to see you teach. Please plan a 20-minute lesson for the class you will be told about on arrival, and bring any materials you need. {slots}.",
  "Final review": "Hello {name}, thank you for completing all the rounds for {role} at Healthy Planet School. Your interview feedback is now with our Director for a final decision, and we will be in touch within a week.",
  "HR discussion": "Hello {name}, good news: we would like to take your application for {role} forward. Our HR team will call you to discuss compensation, joining timelines and school policies. Please reply with a convenient time.",
