...
if (!db.prepare("SELECT 1 FROM roles LIMIT 1").get()) {
  ...
  const r1 = ins.run("Primary Teacher (Grades 3 to 5)", "Primary", "Noida", 2, JSON.stringify([
    ...
    JSON.stringify([
      { text: "Tell me about a lesson with your Grade 3 to 5 class that did not go to plan and what you did next.", assesses: "Reflection and growth" }, { text: "Describe a piece of feedback from a colleague, parent or child that changed how you teach.", assesses: "Reflection and growth" },
      { text: "How do you get a quiet nine- or ten-year-old to take part in class discussion?", assesses: "Child-centred practice" }, { text: "A child in your Grade 4 class is bright but hands in work that is always half finished. What do you do in the first two weeks?", assesses: "Child-centred practice" },
      { text: "Describe a project or investigation your class carried out over several weeks: what the children did, and what they learned.", assesses: "Inquiry or project-based learning" }, { text: "Tell me about a time you let the children's questions change the direction of a unit.", assesses: "Inquiry or project-based learning" },
      { text: "How do you know, before the end of a lesson, which children have not understood?", assesses: "Subject knowledge" }, { text: "Pick a Grade 4 topic you enjoy teaching and tell me the mistake children most often make with it, and how you head it off.", assesses: "Subject knowledge" },
      { text: "What does a healthy classroom look like to you?", assesses: "School values" }, { text: "Why Healthy Planet School, and what would you want to be known for here after a year?", assesses: "School values" },
    ]));
